...
"""
Unified entrypoint for 4myPown.

Usage:
  pawn                     -> launch interactive chat UI
  pawn "objective" [flags] -> run single-shot agent (auto inserts --prompt)
  pawn --prompt "obj" ...  -> identical to python pown_cli.py --prompt ...
"""
...
def _load_agent_module():
    loader = SourceFileLoader("pown_cli_main", str(Path(__file__).resolve().parent / "pown_cli.py"))
