...
Suno is a deliberately vulnerable banking-style web service designed to stress-test the Uxarion CLI agent. It exposes multiple non-SQL injection attack surfaces so you can validate end‑to‑end reconnaissance, exploitation, and reporting workflows.
